...
<html>
<head>
  <title>Treasure Maps - 360 Media and VR Content Management</title>
...
<div class="col-sm-6">
   ...
   VR is here and growing in popularity, yet to many it seems too complicated or expensive to use. Treasuremaps VR tool suite and CMS are easy to use and can help you quickly launch your own virtual world that is rich with infospots. Treasuremaps, unlike the static Youtube and Facebook VR viewers, is adding plugins and addons all the time. You can make VR stores, VR insurance damage assesment, virtual classrooms, live 360 real estate open houses and much more.
	...
	<h2 style="text-align: center">Demo Treasure Maps</h2>
    <div class="row">
